...
返回的4个数据帧的流控会顺次递增。当返回的数据帧超过数据范围时，超出的数据包将不会返回。
  ...
  例1：
    ...
    * ``MCU->:`` ``fc`` , ``length=10`` , ``0x08`` , ``0x11`` ,
      ``{0x06,0xF2,0x3D,0x5B}时间戳(0x5B3DF206)`` , ``{0x01}(计步数据)`` , ``{0xFF}`` , ``{0xE8,0x03}(1000步)``

  例2：
    * ``->MCU:`` ``fc`` , ``length=7`` , ``0x08`` , ``0x11`` ,
      ``0x01`` , ``0x01`` , ``0x05`` , ``0x00`` , ``0x01`` burst模式获取第5和第6个计步数据包
    * ``MCU->:`` ``fc`` , ``length=18`` , ``0x08`` , ``0x11`` ,
      ``{0x06,0xF2,0x3D,0x5B}时间戳1(0x5B3DF206)`` , ``{0x01}(计步数据)`` , ``{0xFF}`` , ``{0xE8,0x03}(1000步)`` ,
      ``{0xB0,0xF2,0x3D,0x5B}时间戳2(0x5B3DF2B0)`` , ``{0x01}(计步数据)`` , ``{0xFF}`` , ``{0xE7,0x03}(999步)``

  例3：
    * ``->MCU:`` ``fc`` , ``length=6`` , ``0x08`` , ``0x11`` ,
      ``0x01`` , ``0x02(心率数据)`` , ``0x02`` , ``0x00`` 普通模式获取第2个心率数据包
    * ``MCU->:`` ``fc`` , ``length=10`` , ``0x08`` , ``0x11`` ,
      ``{0x06,0xF2,0x3D,0x5B}时间戳(0x5B3DF206)`` , ``{0x02}(心率数据)`` , ``{0x51}(心率81)``

  例4：
    * ``->MCU:`` ``fc`` , ``length=7`` , ``0x08`` , ``0x11`` ,
      ``0x01`` , ``0x02`` , ``0x04`` , ``0x00`` , ``0x01`` burst模式获取第4和第5个心率数据包
    * ``MCU->:`` ``fc`` , ``length=14`` , ``0x08`` , ``0x11`` ,
      ``{0x06,0xF2,0x3D,0x5B}时间戳1(0x5B3DF206)`` , ``{0x02}(心率数据)`` , ``{0x51}(心率81)`` ,
      ``{0xB0,0xF2,0x3D,0x5B}时间戳2(0x5B3DF2B0)`` , ``{0x02}(心率数据)`` , ``{0x53}(心率83)``

当使用 ``burst`` 模式获取到超出范围的数据包时，数据类型会填充为 ``0xFF``

  例5：
    * ``->MCU:`` ``fc`` , ``length=7`` , ``0x08`` , ``0x11`` ,
      ``0x01`` , ``0x01`` , ``0x04`` , ``0x00`` , ``0x11`` ``burstx4`` 模式获取第4至第11个计步数据包
    * ``MCU->:`` ``fc`` , ``length=18`` , ``0x08`` , ``0x11`` ,
      ``{0x06,0xF2,0x3D,0x5B}时间戳1(0x5B3DF206)`` , ``{0x01}(计步数据)`` , ``{0xFF}`` , ``{0xE8,0x03}(1000步)`` ,
      ``{0xB0,0xF2,0x3D,0x5B}时间戳2(0x5B3DF2B0)`` , ``{0x01}(计步数据)`` , ``{0xFF}`` , ``{0xE7,0x03}(999步)``
